...
export default function Home() {
  ...
  return (
    <main className="relative z-10 min-h-screen">
      ...
      <footer className="relative overflow-hidden border-t border-white/10 bg-gradient-to-br from-gray-900 via-[#0f0c29] to-[#302b63]">
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <div className="footer-glow-orb w-96 h-96 bg-primary-500/20 -top-48 -right-48 animate-delay-200" />
          <div className="footer-glow-orb w-80 h-80 bg-accent-500/20 -bottom-40 -left-40 animate-delay-500" />
          <div className="footer-glow-orb w-64 h-64 bg-brand-500/15 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 animate-delay-700" />
          <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-50" />
        </div>

        <div className="relative max-w-6xl mx-auto px-4 py-16 md:py-20">
          <div className="grid md:grid-cols-3 gap-12 md:gap-8">
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center md:text-left">
              ...
              <div className="flex items-center justify-center md:justify-start gap-4 mt-5">
                <a href="/privacy-policy" className="text-xs text-gray-500 hover:text-primary-300 transition-colors underline underline-offset-4 decoration-gray-700 hover:decoration-primary-400">Privacy</a>
                <span className="text-gray-700">|</span>
                <a href="/terms" className="text-xs text-gray-500 hover:text-primary-300 transition-colors underline underline-offset-4 decoration-gray-700 hover:decoration-primary-400">Terms</a>
              </div>
            </motion.div>

            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.15 }} className="text-center md:text-left">
              ...
              <div className="space-y-3">
                <h3 className="text-lg font-bold text-white">Venkat Shyam.N</h3>
                <div className="flex flex-wrap items-center justify-center md:justify-start gap-1.5">
                  <span className="badge-glow from-primary-500/20 to-accent-500/10 border border-primary-500/20 text-primary-300">Digital Marketer</span>
                  <span className="badge-glow from-accent-500/20 to-primary-500/10 border border-accent-500/20 text-accent-300">UI/UX Designer</span>
                  <span className="badge-glow from-brand-500/20 to-accent-500/10 border border-brand-500/20 text-brand-300">Graphic Designer</span>
                  <span className="badge-glow from-primary-500/10 to-accent-500/20 border border-primary-500/20 text-primary-300">Artist</span>
                  <span className="badge-glow from-accent-500/10 to-brand-500/20 border border-accent-500/20 text-accent-300">AI Creator</span>
                </div>
                <div className="pt-2 space-y-2.5">
                  <div className="flex items-center justify-center md:justify-start gap-2.5 text-sm text-gray-400">
                  ...
                  <a href="tel:+919949994082" className="flex items-center justify-center md:justify-start gap-2.5 text-sm text-gray-400 hover:text-primary-300 transition-colors group">
                  ...
                  <a href="mailto:vsnagoju@gmail.com" className="flex items-center justify-center md:justify-start gap-2.5 text-sm text-gray-400 hover:text-accent-300 transition-colors group">
            ...
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.3 }} className="text-center md:text-left">
              ...
              <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.5 }} className="mt-6 p-4 rounded-xl bg-gradient-to-r from-brand-500/10 via-accent-500/10 to-primary-500/10 border border-white/10">
                <p className="text-xs text-gray-400 mb-3">Let&apos;s bring your ideas to life</p>
                <a href="https://wa.me/919949994082?text=Hi%20Venkat%2C%20I%20visited%20your%20BG%20Remover%20tool%20and%20I'm%20interested%20in%20your%20services" target="_blank" rel="noopener noreferrer" className="gradient-btn-glow inline-flex items-center justify-center gap-2 w-full px-5 py-3 text-sm">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" />
                  </svg>
                  Hire Me &mdash; Let&apos;s Talk
                </a>
              </motion.div>
            </motion.div>
          </div>
          ...
          <div className="mt-12 pt-8 border-t border-white/5">
            <p className="text-xs text-gray-600 text-center leading-relaxed">
              &copy; {new Date().getFullYear()} BG Remover &mdash; Crafted with passion by{" "}
      ...
      <div className="whatsapp-float group">
        <div className="whatsapp-tag group-hover:opacity-100 group-hover:translate-x-0">
          <span className="gradient-text-premium font-bold">Hire Us</span>
          &nbsp;&mdash;&nbsp;
          <span className="text-gray-500">Get a Free Quote</span>
        </div>
        <a
          href="https://wa.me/919949994082?text=Hi%20Venkat%2C%20I%20visited%20your%20BG%20Remover%20tool%20and%20I'm%20interested%20in%20your%20services"
          target="_blank"
      ...
      {!originalUrl && (
        <motion.div initial={{ y: 100 }} animate={{ y: 0 }} className="fixed bottom-0 left-0 right-0 p-4 bg-white/90 backdrop-blur-lg border-t border-gray-100 md:hidden z-40">
